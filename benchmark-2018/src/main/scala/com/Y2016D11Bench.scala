...
//  {
//    val code                               = k * 4 + v
//    override def hashCode(): Int           = code //super.hashCode()
//    override def equals(obj: Any): Boolean = code == obj.asInstanceOf[Foo].code // super.equals(obj)
//  }
...
//    !generator || !m.exists(_ == 1)
  ...
  @Benchmark
  def yo() =
    BFS.breadth_first_traverse(init1, moves).find(_._1 == final1).get._2.size - 1

  def part1(lines: Iterator[String]): Int = part(init1, final1)(lines.toList)

  def part2(lines: Iterator[String]): Int = part(init2, final2)(lines.toList)
