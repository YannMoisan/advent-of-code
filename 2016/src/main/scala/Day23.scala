...
object Day23 extends MultiPuzzle[Int, Int] {
  ...
  override def part1(lines: Iterator[String]): Int = part(Map[String, Int]("a" -> 7).withDefaultValue(0))(lines.toList)

  override def part2(lines: Iterator[String]): Int = part(Map[String, Int]("a" -> 12).withDefaultValue(0))(lines.toList)
}
