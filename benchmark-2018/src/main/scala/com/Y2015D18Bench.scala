...
class Y2015D18Bench {
  ...
  def nextState_foreach(grid: Array[Array[Char]], neighborIndices: (Int, Int) => Seq[(Int, Int)]): Array[Array[Char]] = {
    val newState = Array.ofDim[Char](grid.size, grid.head.size)
  ...
  def nextState_while(grid: Array[Array[Char]], neighborIndices: (Int, Int) => Seq[(Int, Int)]): Array[Array[Char]] = {
    val newState = Array.ofDim[Char](grid.size, grid.head.size)
  ...
  def nextState_no_lambda_call(grid: Array[Array[Char]], neighborIndices: (Int, Int) => Seq[(Int, Int)]): Array[Array[Char]] = {
    val newState = Array.ofDim[Char](grid.size, grid.head.size)
  ...
  def nextState_no_method_call(grid: Array[Array[Char]], neighborIndices: (Int, Int) => Seq[(Int, Int)]): Array[Array[Char]] = {
    val newState = Array.ofDim[Char](grid.size, grid.head.size)
  ...
  def nextState_vector_array(grid: Array[Array[Char]], neighborIndices: (Int, Int) => Seq[(Int, Int)]): Array[Array[Char]] = {
    val newState = Array.ofDim[Char](grid.size, grid.head.size)
